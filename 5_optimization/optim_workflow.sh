...
GP_FOLDER=$SIM_FOLDER"gp_5/trained/incred/"
GP_AS_FOLDER=$GP_FOLDER"as/"
OPT_SETUP_FILE=$SIM_FOLDER"gp_5/optimisation/incred/opt_setup_file.txt"
OPT_DEST_DIR=$SIM_FOLDER"gp_5/optimisation/incred/"
...
do
    sbatch --array=1-$NUM job_optim_GP.sh $GP_FOLDER $PARAM_RANGES_FILE $OPT_DEST_DIR $OPT_SETUP_FILE $row_n
