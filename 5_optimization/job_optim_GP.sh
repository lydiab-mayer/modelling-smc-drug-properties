...
#SBATCH -o /scicore/home/smith/burlyd00/smc_lai/JOB_OUT/optimisation_analysis.out
#SBATCH --mem=10G
#SBATCH --qos=6hours
...
Rscript get_optim_profile_incred.R $gp_file $PARAM_RANGES_FILE $OPT_DEST_DIR $OPT_SETUP_FILE $ROW
