...
no.commands=as.numeric(system(paste0("wc -l < /scicore/home/penny/GROUP/smc_lai/",exp, "/param_tab.txt"), intern = TRUE))
  ...
  cat("sbatch -W ../job_create_scenarios_ml.sh $PARAM_TABLE_FILE $SCAFFOLD_FILE $BASE_FOLDER $SCENARIOS_FOLDER","\n\n", sep ="")
  
  cat(" echo \"Running OM simulations... \" ","\n", sep ="")
  
  cat("sbatch -W --array=1-$NUM ../run_OM_ml.sh $SCENARIOS_FOLDER $OM_FOLDER","\n\n", sep ="")
