...
# Load data
df <- readRDS("./data_and_visualisation/Appendix_Figure21/data_figA21_panelB.rds")
...
ggsave(filename = paste0("./data_and_visualisation/Appendix_Figure21/figA21_panelB.jpg"),
       plot = last_plot(),
       width = 4.5,
       height = 5,
       dpi = 400)
...
write.csv(tab[, c(1, 2, 5)], file = paste0("./data_and_visualisation/Appendix_Figure21/tab.csv"))
