...
p + q + plot_annotation(title = "Next-generation SMC with dominant blood stage activity and initial, complete liver stage clearance") +
...
ggsave(filename = paste0("./data_and_visualisation/Manuscript_Figure1/fig1_panelB.jpg"),
       ...
       height = 2.5,
       dpi = 400)
ggsave(filename = paste0("./data_and_visualisation/Manuscript_Figure1/fig1_panelB.pdf"),
       plot = last_plot(),
       width = 9.1,
       height = 2.5,
       dpi = 400)
