...
# Load data
data <- readRDS("./data_and_visualisation/Appendix_Figure210/data_figA210_panelB.rds")
...
ggsave(filename = paste0("./data_and_visualisation/Appendix_Figure210/figA210_panelB.jpg"),
       plot = p_out,
       width = 4.5,
       height = 4.35,
       dpi = 400)
