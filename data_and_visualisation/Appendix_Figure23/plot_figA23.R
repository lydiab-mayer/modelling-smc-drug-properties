...
# Load data
df <- readRDS("./data_and_visualisation/Appendix_Figure23/data_figA23.rds")
...
ggsave(filename = paste0("./data_and_visualisation/Appendix_Figure23/figA23.jpg"),
       plot = last_plot(),
       width = 9.1,
       height = 9.1,
       dpi = 400)
