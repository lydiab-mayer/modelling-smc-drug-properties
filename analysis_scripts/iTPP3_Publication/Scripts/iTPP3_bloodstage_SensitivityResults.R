...
exp <- exp_list #for(exp in exp_list) {
  ...
  df$parameter <- recode(df$parameter,
                         "Coverage1" = "SMC program coverage [70% - 90%]",
                         "Coverage2" = "SMC round coverage [70% - 90%]",
                         "MaxKillingRate" = "Max. killing rate [2 - 30 units]",
                         "Halflife" = "Concentration halflife [5 - 40 days]",
                         "Slope" = "Slope [1 - 8]")
  
  df$Outcome <- factor(df$Outcome, levels = c("inc", "sev", "prev", "mor"))
  ...
  #df_plot <- df_plot[df_plot$Outcome %in% c("CLINICAL INCIDENCE", "SEVERE DISEASE"), ]
  ...
  ggsave(filename = paste0("./analysisworkflow/analysis_scripts/iTPP3_Publication/Figures/iTPP3_", exp, "_FIG332.jpg"),
         plot = last_plot(),
         width = 9.1,
         height = 5,
         dpi = 400)
  ...
  write.csv(tab[, c(1, 2, 5)], file = paste0("./analysisworkflow/analysis_scripts/iTPP3_Publication/Figures/iTPP3_", exp, "_TABA21.csv"))
  ...
  ggsave(filename = paste0("./analysisworkflow/analysis_scripts/iTPP3_Publication/Figures/iTPP3_", exp,"_FIG631.jpg"),
         plot = last_plot(),
         width = 9.1,
         height = 9.1,
         dpi = 300)
  ...
  ggsave(filename = paste0("./analysisworkflow/analysis_scripts/iTPP3_Publication/Figures/iTPP3_", exp, "_FIG731.jpg"),
         plot = last_plot(),
         width = 9.1,
         height = 5,
         dpi = 300)
