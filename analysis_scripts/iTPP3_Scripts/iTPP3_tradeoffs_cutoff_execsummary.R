...
out[1, ] <- c("Scenario", "Target", "Coverage1", "Coverage2", "Halflife", "Efficacy")
...
for(exp in exp_list) {
  ...
  for(i in 1:length(setting_id)){
    ...
    out_int[1, ] <- c("Scenario", "Target", "Coverage1", "Coverage2", "Halflife", "Efficacy")
...
out <- out[, c("Scenario", "PfPR2_10", "Endpoint", "Impact", "Coverage1", "Coverage2", "Halflife", "Efficacy")]
