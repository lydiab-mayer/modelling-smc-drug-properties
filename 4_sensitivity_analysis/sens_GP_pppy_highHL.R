...
# For testing:
 # gp_file = "/scicore/home/penny/GROUP/smc_lai/E3E4disc_comparison/gp_trained/gp_trained_pppy_LAI_Sen_4.9167_exp_0.1_4.RData"
  ranges_file = "/scicore/home/penny/GROUP/smc_lai/E4_SMCLAIdisc/param_ranges.RData"
 # results_folder = "/scicore/home/smith/GROUP/smc_lai/E3E4_lb/sensitivity/"


exp_name = tools::file_path_sans_ext(basename(gp_file))
sidx_file = paste(results_folder, exp_name, "_sidx_highls.RData", sep="")
